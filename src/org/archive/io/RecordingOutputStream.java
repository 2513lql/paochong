 ...
 * by {@link org.archive.io.RecordingInputStream} to which it records all reads.
 * {@link org.archive.io.RecordingInputStream} is exploiting the file backed buffer
...
public class RecordingOutputStream extends OutputStream {
     ...
     *
     * @throws java.io.IOException If failed creation of backing file.
     */
     ...
     *
     * @exception java.io.IOException Failed write to backing file.
     */
     ...
     * The difference between calling this method and {@link #setDigest(java.security.MessageDigest)}
     ...
     * @see #setDigest(java.security.MessageDigest)
     */
