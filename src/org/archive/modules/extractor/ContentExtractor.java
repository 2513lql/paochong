...
public abstract class ContentExtractor extends Extractor {
     ...
     * {@link org.archive.modules.extractor.ExtractorURI#hasBeenLinkExtracted()} result. If that result is
     ...
     * 
     * <p>
     * Finally, this method delegates to {@link #innerExtract(org.archive.modules.extractor.ExtractorURI)} and
     * returns that result.
     * 
     * @param uri
     *            the URI to check
     ...
     * the {@link org.archive.modules.extractor.ExtractorHTML} implementation checks that the content-type of
     ...
     * checks described in {@link #shouldProcess(org.archive.modules.extractor.ExtractorURI)}.  Subclasses
     * should implement this method to discover outlinks in the URI's 
     * content stream.  For instance, {@link org.archive.modules.extractor.ExtractorHTML} extracts links
