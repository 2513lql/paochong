 ...
 * To this, we have dependency on {@link org.archive.modules.fetcher.HeritrixProtocolSocketFactory};
 * its assumed this class and it are used together.
 * See {@link org.archive.modules.fetcher.HeritrixProtocolSocketFactory#getHostAddress(ServerCache,String)}.
 *
 * @author stack
