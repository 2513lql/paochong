...
implements ObjectIdentityCache<V>, Closeable, Serializable, MapEvictionListener<String, V> {
    ...
    /** Count of times the {@link org.archive.util.ObjectIdentityBdbManualCache#get} method was called. */
     ...
     * {@link #CachedBdbMap(java.io.File, String, Class, Class)} constructor.
     * @param env
     * @param keyClass
     * @param valueClass
     * @param classCatalog
