 ...
 * <p>
 * Paths are checked available space whenever a {@link org.archive.crawler.event.StatSnapshotEvent} occurs.
 * 
...
public class DiskSpaceMonitor implements ApplicationListener {
    ...
    /**
     * If enabled, all the paths returned by {@link org.archive.spring.ConfigPathConfigurer#getAllConfigPaths()}
     * will be monitored in addition to any paths explicitly specified via
     * {@link #setMonitorPaths(java.util.List)}.
     * <p>
     ...
     * with the {@link org.archive.spring.ConfigPathConfigurer} and some may not do so.
     * 
    ...
    /**
     * Checks available space on {@link org.archive.crawler.event.StatSnapshotEvent}s.
     */
    @Override
