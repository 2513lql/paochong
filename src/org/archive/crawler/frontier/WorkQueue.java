...
public abstract class WorkQueue implements Frontier.FrontierGroup,
     ...
     * @param frontier WorkQueueFrontier.
     * @param curi CrawlURI to insert.
     * @throws java.io.IOException  if there was a problem while inserting the item
     */
     ...
     * @return count of deleted URIs
     * @throws java.io.IOException  if there was a problem while deleting
     */
     ...
     * 
     * @param frontier  Work queues manager.
     * @throws java.io.IOException  if there was a problem while deleting the item
     */
     ...
     * @throws java.io.IOException  if there was a problem while peeking
     */
