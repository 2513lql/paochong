...
//      END IA/HERITRIX CHANGES
     ...
     * 
     * @throws java.io.IOException If an I/O (transport) problem occurs while obtaining the
     * response body.
     */
    ...
    /**
     * Returns the response body of the HTTP method, if any, as an {@link java.io.InputStream}.
     ...
     * @param conn the {@link org.apache.commons.httpclient.HttpConnection connection} to be used
     ...
     * <code>HttpState</code>. 
     *
     * @param state {@link org.apache.commons.httpclient.HttpState state} information to associate with this
     *        request. Must be non-null.
     * @param conn the {@link org.apache.commons.httpclient.HttpConnection connection} to used to execute
     *        this HTTP method. Must be non-null.
     *
     * @return the integer status code if one was obtained, or <tt>-1</tt>
     *
     * @throws java.io.IOException if an I/O (transport) error occurs
    ...
    /**
     * Generates <tt>Cookie</tt> request headers for those {@link org.apache.commons.httpclient.Cookie cookie}s
     ...
     * to be submitted via the given {@link org.apache.commons.httpclient.HttpConnection connection}.
     *
     * <p>
     ...
     *
     * @param connection the {@link org.apache.commons.httpclient.HttpConnection connection} used to execute
     *        this HTTP method
     ...
     * {@link #readResponseBody(org.apache.commons.httpclient.HttpState, org.apache.commons.httpclient.HttpConnection)} and can be overridden by
    ...
    /**
     * This method is invoked immediately after 
     * {@link #readResponseHeaders(org.apache.commons.httpclient.HttpState, org.apache.commons.httpclient.HttpConnection)} and can be overridden by
     ...
     * the given {@link org.apache.commons.httpclient.HttpState}.
     * </p>
     *
     * @param state the {@link org.apache.commons.httpclient.HttpState state} information associated with this method
     * @param conn the {@link org.apache.commons.httpclient.HttpConnection connection} used to execute
    ...
    /**
     * This method is invoked immediately after 
     * {@link #readStatusLine(org.apache.commons.httpclient.HttpState, org.apache.commons.httpclient.HttpConnection)} and can be overridden by
    ...
    /**
     * Reads the response from the given {@link org.apache.commons.httpclient.HttpConnection connection}.
     *
     * <p>
     ...
     * <ol>
     * <li>
     * {@link #readStatusLine(org.apache.commons.httpclient.HttpState, org.apache.commons.httpclient.HttpConnection)} is
     * invoked to read the request line.
     * </li>
     * <li>
     * {@link #processStatusLine(org.apache.commons.httpclient.HttpState, org.apache.commons.httpclient.HttpConnection)}
     * is invoked, allowing the method to process the status line if
     * desired.
     * </li>
     * <li>
     * {@link #readResponseHeaders(org.apache.commons.httpclient.HttpState, org.apache.commons.httpclient.HttpConnection)} is invoked to read
     * the associated headers.
     * </li>
     * <li>
     * {@link #processResponseHeaders(org.apache.commons.httpclient.HttpState, org.apache.commons.httpclient.HttpConnection)} is invoked, allowing
     * the method to process the headers if desired.
     * </li>
     * <li>
     * {@link #readResponseBody(org.apache.commons.httpclient.HttpState, org.apache.commons.httpclient.HttpConnection)} is
     * invoked to read the associated body (if any).
     * </li>
     * <li>
     * {@link #processResponseBody(org.apache.commons.httpclient.HttpState, org.apache.commons.httpclient.HttpConnection)} is invoked, allowing the
    ...
    /**
     * Read the response body from the given {@link org.apache.commons.httpclient.HttpConnection}.
     *
     * <p>
    ...
    /**
     * Returns the response body as an {@link java.io.InputStream input stream}
    ...
    /**
     * Reads the response headers from the given {@link org.apache.commons.httpclient.HttpConnection connection}.
     *
     * <p>
     * Subclasses may want to override this method to to customize the
     * processing.
    ...
    /**
     * Read the status line from the given {@link org.apache.commons.httpclient.HttpConnection}, setting my
    ...
    /**
     * <p>
     * Sends the request via the given {@link org.apache.commons.httpclient.HttpConnection connection}.
     * </p>
     *
     * <p>
     ...
     * <ol>
     * <li>
     * {@link #writeRequestLine(org.apache.commons.httpclient.HttpState, org.apache.commons.httpclient.HttpConnection)} is invoked to
     * write the request line.
     * </li>
     * <li>
     * {@link #writeRequestHeaders(org.apache.commons.httpclient.HttpState, org.apache.commons.httpclient.HttpConnection)} is invoked
     ...
     * </li>
     * <li>
     * {@link #writeRequestBody(org.apache.commons.httpclient.HttpState, org.apache.commons.httpclient.HttpConnection)} is invoked to
    ...
    /**
     * Writes the request headers to the given {@link org.apache.commons.httpclient.HttpConnection connection}.
     *
     * <p>
     * This implementation invokes {@link #addRequestHeaders(org.apache.commons.httpclient.HttpState, org.apache.commons.httpclient.HttpConnection)},
    ...
    /**
     * Writes the request line to the given {@link org.apache.commons.httpclient.HttpConnection connection}.
     *
     * <p>
     * Subclasses may want to override this method to to customize the
     * processing.
